...
class CalendarAgendaState extends State<CalendarAgenda> with TickerProviderStateMixin {
    ...
    Widget dayList() {
      return Container(
        ...
        child: ScrollablePositionedList.builder(
            ...
            initialAlignment: widget.selectedDayPosition == SelectedDayPosition.center ? 78 / 200 : _scrollAlignment,
                            ...
                            children: [
                              ...
                              Text(
                                widget.weekDay == WeekDay.long
                                    ? DateFormat.EEEE(Locale(_locale).toString()).format(date)
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    widget.fullCalendar!
                        ? GestureDetector(
                            onTap: () => widget.fullCalendar! ? _showFullCalendar(_locale, widget.weekDay) : null,
                            child: Row(
                              children: [
                                Icon(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 60,
                height: 6,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(3.0), color: Color(0xFFE0E0E0)),
              ),
              SizedBox(
                height: 20.0,
              ),
  ...
  _selectedDay() {
    DateTime getSelected = DateTime.parse("${_selectedDate.toString().split(" ").first} 00:00:00.000");

    _daySelectedIndex = _dates.indexOf(_dates
        .firstWhere((dayDate) => DateTime.parse("${dayDate.toString().split(" ").first} 00:00:00.000") == getSelected));
  }
  ...
  void _moveToDayIndex(int index) {
    ...
    _scrollController.scrollTo(
      index: index,
      alignment: widget.selectedDayPosition == SelectedDayPosition.left ? 78 / 200 : _scrollAlignment,
      duration: Duration(milliseconds: 500),
      curve: Curves.easeInOut,
    );
  }

  // Future<void> jumpTOCurrentDate() async {
  //   await Future.delayed(const Duration(seconds: 1));
  //   await dateScrollController.animateTo(
  //     5 * 47,
  ...
  _initCalendar() {
    if (widget.controller != null && widget.controller is CalendarAgendaController) {
